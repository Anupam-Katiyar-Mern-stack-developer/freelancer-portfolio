...
const ProjectsHero = () => {
  ...
  const hero = siteData?.projectsPage?.hero;
  ...
  return (
    <section className="relative overflow-hidden bg-[#F8FAFC] px-5 pb-20 pt-36 sm:px-8 lg:px-10 lg:pb-28 lg:pt-40">
      ...
      <div className="pointer-events-none absolute -right-40 top-20 h-[420px] w-[420px] rounded-full bg-violet-200/40 blur-[140px]" />
      ...
      >
        ...
        <h1 className="mx-auto mt-6 max-w-5xl font-['Space_Grotesk'] text-5xl font-bold leading-[1.02] tracking-[-0.055em] text-slate-950 sm:text-6xl lg:text-7xl">
          {hero.heading}
